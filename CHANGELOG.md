...
- 2026-09-24 | Compañero/opencode | contratos | PUT services y reserve de capacidad en `api-catalog.md`; D2 cerrada (se mantiene inglés + PATCH); filas de audience y capacidad al día.
