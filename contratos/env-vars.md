...
| `ms-rutaexpress-catalog` | 8082 | `AZURE_TENANT_ID`, `DB_*` |
| `ms-rutaexpress-notify` | 8083 | `AZURE_TENANT_ID`, `RABBITMQ_*`, `DB_*` |
| `ms-rutaexpress-report` | 8084 | `AZURE_TENANT_ID`, `KAFKA_BOOTSTRAP_SERVERS` |
| `ms-rutaexpress-audit` | 8085 | `AZURE_TENANT_ID`, `KAFKA_BOOTSTRAP_SERVERS`, `DB_*` |
